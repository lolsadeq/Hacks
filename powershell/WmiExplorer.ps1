...
Function ConnectToComputer {
    ...
    if ($Script:ConnectionOptions.Username) {
      $cred = Get-Credential $Script:ConnectionOptions.Username
      $Script:ConnectionOptions.Username = $cred.GetNetworkCredential().UserName
      $Script:ConnectionOptions.Password = $cred.GetNetworkCredential().password
    }
